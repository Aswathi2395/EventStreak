...
<img src="images.jpeg" height="80" width="80"/>
</a>

<a class="navbar-brand text-danger fw-bold" style="font-size:36px;">EventStreak</a>
...
<input type="text" class="form-control" placeholder="Venue / Location"
style="background-color:#CCCCCC;
font-family:Verdana, Arial, Helvetica, sans-serif;
font-size:14px;
font-weight:800;
...
<textarea class="form-control" rows="3" placeholder="Describe the event"
style="background-color:#CCCCCC;
font-family:Verdana, Arial, Helvetica, sans-serif;
font-size:14px;
font-weight:800;
font-style:italic"></textarea>
...
<input type="tel" class="form-control" placeholder="Phone / Email"
style="background-color:#CCCCCC;
font-family:Verdana, Arial, Helvetica, sans-serif;
font-size:14px;
font-weight:800;
