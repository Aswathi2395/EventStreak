...
<input type="radio" class="form-check-input" name="role" id="organiser" value="ORGANISER">
<label class="form-check-label">Organiser</label>
...
<a href="login.php" style="color:#CCFFFF;">LOGIN</a>
</p>
